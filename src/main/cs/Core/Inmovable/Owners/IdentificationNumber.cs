...
/// <summary>
/// Represents an owner's identification number.
/// </summary>
...
IEquatable<IdentificationNumber>, IComparable<IdentificationNumber>
{
    ...
    /// <summary>
    /// Validates raw owner's identification number and creates a valid instance or throw exceptions.
    /// </summary>
    /// <param name="rawIdentificationNumber">Raw owner's identification number.</param>
    public IdentificationNumber(string rawIdentificationNumber)
    {
        Message genericMessage = new("Invalid value or format for owner IdentificationNumber.");
