...
/// <summary>
/// Validates raw owner's name and creates a valid instance or throw exceptions.
/// </summary>
/// <param name="rawName">Represents the raw owner's name.</param>
public Name(string rawName)
{
    Message genericMessage = new("Invalid value or format for owner Name.");
